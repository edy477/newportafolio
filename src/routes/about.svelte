...
<div  class="about shadow-2xl antialiased border-3 rounded-sm border-gray-200  border-solid overflow-hidden shadow-lg bg-gray-100 ">
<div class="myimage pt-10">

		<img src="/profile.jpg" alt="profile"  class="transform scale-75 -rotate-90 rounded border-r-4"/>
